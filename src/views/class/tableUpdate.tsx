...
import type { UpdateSuccess } from '@/types/management/classType'
import StyledTableRow from '@/components/table/StyledTableRow'

export default function TableUpdate({ updateData }: { updateData: UpdateSuccess[] }) {
  if (updateData.length === 0) {
    return (
      <Typography variant='h3' color='textSecondary'>
        Không có lớp nào được cập nhật
      </Typography>
    )
  }
