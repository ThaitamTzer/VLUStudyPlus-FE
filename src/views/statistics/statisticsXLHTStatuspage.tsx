...
export default function StatisticsXLHTStatusPage() {
  ...
  const handleExportExcel = useCallback(async () => {
    ...
    try {
      ...
      const worksheet = workbook.addWorksheet('Thống kê XLHT theo trạng thái')
      ...
      worksheet.mergeCells(universityRow.number, 1, universityRow.number, 5)
      ...
      worksheet.mergeCells(facultyRow.number, 1, facultyRow.number, 5)
      ...
      const headers = ['STT', 'Trạng thái', 'Học kỳ', 'Ngành', 'Tổng số lượng']
