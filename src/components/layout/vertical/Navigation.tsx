...
const StyledBoxForShadow = styled('div')(({ theme }) => ({
  ...
  }, rgb(var(--mui-palette-background-paperChannel) / 0.65) 30%, rgb(var(--mui-palette-background-paperChannel) / 0.5) 65%, rgb(var(--mui-palette-background-paperChannel) / 0.3) 75%, transparent)`,
  '&.scrolled': {
    opacity: 0.1
  }
}))
...
const Navigation = (props: Props) => {
  ...
  return (
    ...
    <VerticalNav
      ...
      collapsedWidth={71}
      backgroundColor='rgb(46, 80, 119, 0.7)'
