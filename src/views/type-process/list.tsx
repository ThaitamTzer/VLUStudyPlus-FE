...
export default function TableTypeProcess({ table, loading }: { table: Table<any>; loading: boolean }) {
  return (
      ...
      <MuiTable stickyHeader sx={{ minWidth: 1000 }}>
        ...
        <TableBody>
          ...
          {loading && table.getRowModel().rows.length === 0 ? (
            ...
            <TableNoData notFound={table.getRowModel().rows.length === 0} title='Không tìm thấy sinh viên nào' />
          )}
        </TableBody>
      </MuiTable>
    </TableContainer>
