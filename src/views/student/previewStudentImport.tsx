...
import TableLecturersDuplicate from './tableStudentsDuplicate'
import { useStudentStore } from '@/stores/student/student'
import TableStudentsResults from './tableStudentsResults'
import TableStudentMissing from './tableStudentsMissing'

export default function PreviewStudentImport() {
  const { openImportResult, duplicateRows, missingInfoRows, toogleImportResult, studentsResult, updatedStudents } =
    useStudentStore()
        ...
        <TabContext value={tab}>
          <TabList onChange={handleChangeTab} variant='scrollable' scrollButtons='auto'>
            <Tab
              ...
              label={
                <>
                  Sinh viên đã thêm mới <Badge>{studentsResult?.length}</Badge>
                </>
              }
            ...
            <Tab
              ...
              label={
                <>
                  Sinh viên đã cập nhật <Badge>{updatedStudents.length}</Badge>
                </>
              }
          ...
          <TabPanel value={'1'}>
            <TableStudentsResults studentsResult={studentsResult} />
          ...
          <TabPanel value={'2'}>
            <TableStudentsResults studentsResult={updatedStudents} />
          ...
          <TabPanel value={'3'}>
            <TableStudentMissing missingInfoRows={missingInfoRows} />
          </TabPanel>
          <TabPanel value={'4'}>
